...
struct sensorDataStruct mySensorData;
...
void readSensors(struct sensorDataStruct *_sensorData){
  ...
  _sensorData->soilMoistureLevel = readMoistureLevels();
}
...
void printSoilMoistureLevel(){
  ...
  carrier.display.print(mySensorData.soilMoistureLevel); // display the temperature on the screen
  carrier.display.print(" %");
